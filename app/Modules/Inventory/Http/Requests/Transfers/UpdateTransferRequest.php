...
class UpdateTransferRequest extends FormRequest
{
    ...
    public function authorize(): bool
    {
        ...
        return $transfer instanceof Transfer
            ? $this->user()->can('update', $transfer)
            : $this->user()->can('update', Transfer::class);
    }

    /**
     * قواعد التحقق الخاصة بتحديث أمر تحويل قائم
     */
    public function rules(): array
    {
        ...
        return [
            'transfer_number' => ['required', 'string', 'max:100', Rule::unique('inventory_transfers', 'transfer_number')->ignore($transferId)->whereNull('deleted_at')],
